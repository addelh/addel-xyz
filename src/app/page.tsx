...
const projects: Project[] = [
  ...
  },
  {
    ...
    status: "progress",
    detailsMode: "modal",
    detailsHeading: "Egg's highlights (aka: receipts)",
    detailsItems: [
      "🚀 Shipped real production updates to addel.xyz (iterating fast, safely).",
      "🎨 Styled the project cards to match a comic/hand-drawn reference (borders, CTAs, hover polish).",
      "🖱️ Rebuilt the ink cursor: continuous streak + click splatter + framerate-independent motion (smooth at high Hz).",
      "🧠 Tightened guardrails + logging so work doesn't get lost (crash-safe notes + reminders).",
      "🛒 Optimises ecom content: clearer positioning, stronger CTAs, conversion-first wording (less fluff, more punch).",
      "🤖 Automates repetitive browser/ops loops so Del stays on high-leverage decisions.",
    ],
  },
];
